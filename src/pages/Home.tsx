...
const Home = () => {
    ...
    const { tipo_usuario } = state.auth

    return (
        <div className='flex justify-center flex-col'>
            <div className="z-10 p-5 text-2xl shadow mx-4 font-semibold text-left text-gray-900 bg-white dark:text-white dark:bg-gray-800">
            ...
            <div className='flex justify-center flex-wrap z-10 gap-5 mt-10'>
                <Link to="/auth/formulario-paciente" className='w-[200px] h-[200px] rounded-full bg-gray-100 hover:scale-125 hover:cursor-pointer transition-all shadow-lg flex items-center flex-col justify-center text-gray-700 hover:text-gray-400'>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-full h-6">
                ...
                <Link to="/auth/listado-pacientes" className='w-[200px] h-[200px] rounded-full bg-gray-100 hover:scale-125 hover:cursor-pointer transition-all shadow-lg flex items-center flex-col justify-center text-gray-700 hover:text-gray-400'>
                    ...
                    <p className="uppercase break-words px-5 text-center font-semibold  tracking-wider">Consulta de Pacientes</p>
                </Link>
                {state.auth.tipo_usuario == "ADMINISTRADOR" && (
                    <Link to="/auth/registro-usuario" className='w-[200px] h-[200px] rounded-full bg-gray-100 hover:scale-125 hover:cursor-pointer transition-all shadow-lg flex items-center flex-col justify-center text-gray-700 hover:text-gray-400'>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                        </svg>

                        <p className="uppercase break-words px-5 text-center font-semibold  tracking-wider">Registrar Nuevo Usuario</p>
                    </Link>
